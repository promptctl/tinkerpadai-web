  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          kind: 'p',
          text: `Found a playground that's harmful, illegal, or shouldn't be here? Email ${contactLink}. We review reports and take down anything that breaks the ground rules. If a playground reproduces work you hold the copyright to, see <a href="/copyright">copyright &amp; takedowns</a>.`,
        },
      ],
    },
    {
...
// COPYRIGHT & TAKEDOWNS — an honest takedown-on-notice procedure, NOT a claim of DMCA §512 safe
// harbor. That statutory shield requires a *named* designated agent registered with the U.S.
// Copyright Office, publicly listing the operator's real name and street address — which the "no
// entity, anonymous operator" stance forecloses. So this page claims NO safe harbor and names NO
// registered agent (fabricating one would be a page that lies about itself), and it deliberately
// omits the §512(g) counter-notice put-back clock, which only exists inside the safe-harbor regime
// we are not in. What it DOES do is real: honor takedowns on a valid notice, offer a genuine
// re-review path, and remove repeat infringers — all routed to the one CONTACT_EMAIL, never a second
// enforcer. [FRAMING:representation] [LAW:single-enforcer]
export const COPYRIGHT_DOC: LegalDoc = {
  title: 'Copyright & takedowns',
  description:
    'How to report a playground that reproduces work you hold the copyright to — we review every notice and remove infringing playgrounds promptly.',
  ...
  sections: [
    {
      ...
      blocks: [
        {
          kind: 'p',
          text: `Playgrounds are generated by AI, and AI-generated work generally isn't owned by anyone (see the <a href="/terms">ground rules</a>). But a prompt can still make a playground reproduce someone else's copyrighted work — and if that work is yours, you can ask us to take it down. Email ${contactLink}; we review every notice and remove infringing playgrounds promptly.`,
        },
      ],
    },
    {
      heading: 'How to report copyright infringement',
      blocks: [
        {
          kind: 'p',
          text: `Email ${contactLink} with enough for us to act. A good takedown notice includes:`,
        },
        {
          kind: 'ul',
          items: [
            'The copyrighted work you own — a link to it, or a clear description.',
            'The playground(s) that reproduce it — paste the TinkerPad URL of each one.',
            'How to reach you — a name and an email address.',
            ...
            'Your name, typed as an electronic signature.',
          ],
        },
        {
          kind: 'p',
          text: "That's the standard DMCA-style notice format — you don't need a lawyer to send one.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'p',
          text: 'We review every notice. If the claim holds up, we remove or unlist the playground promptly and let the person who made it know why.',
        },
      ],
    },
    {
      heading: 'If you think we removed something by mistake',
      blocks: [
        {
          kind: 'p',
          text: `Made a playground that was taken down and think it was a mistake? Email ${contactLink} and tell us why — for example, the work is yours, it's licensed to you, or the use is fair. We'll re-review and put it back if the takedown was wrong.`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          kind: 'p',
          text: "People who repeatedly upload work that infringes others' copyright will be blocked, in line with the ground rules.",
        },
      ],
    },
    {
      heading: 'Contact',
      blocks: [{ kind: 'p', text: `Copyright notices and questions: ${contactLink}.` }],
    },
  ],
};
